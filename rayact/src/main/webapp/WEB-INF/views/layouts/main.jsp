...
<div style="font-size: 15px;background-color: #fff;text-align:center;z-index:-100;width:100%;line-height:50px;height:50px;position: absolute;bottom: 0px;left:0px;">
...
<script src="${ctxStatic}/modules/reserve/js/oa_notify.js" type="text/javascript"></script>
</body>
</html>