    ...
    <div class="content text-justify" style="text-align: center;vertical-align: middle;">
        <div class="row">
            ...
            <div class="col-lg-6">
                <div class="row">
                    <div class="form-group">
                        <label for="rechargeVolume" class="control-label col-lg-2">金额:</label>
                        <div class="col-lg-5"><input id="rechargeVolume" name="userName"
                                                     type="text"
        ...
        <div class="row">
            <label for="payType" class="control-label col-lg-2">支付方式:</label>
            <div class="col-lg-10">
                <div class="btn-group" id="payType">
                    ...
                    <label class="radio-inline">
                        <input type="radio" class="icheck" id="storedCard" value="1" name="payType"/>预储值
                    </label>
                    <label class="radio-inline">
